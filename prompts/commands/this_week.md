...
The script automatically saves a snapshot to `data/reports/weekly/YYYY/MM/YYYY-MM-DD-weekly.md` (dated to Monday of the week). Mention the saved file path to the user.
