...
The script automatically saves a snapshot to `reports/weekly-report/YYYY/YYYY-MM-DD.md` (dated to Monday of the week). Mention the saved file path to the user.
